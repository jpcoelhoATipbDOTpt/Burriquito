...
void ShowTimeOnScreen(void){
  ...
  if(now.hour()<10){
    dataString = dataString + "0" + String(now.hour(),DEC);
  }
  else{
    dataString = dataString + String(now.hour(),DEC);
  }

  if(now.minute()<10){
    dataString = dataString + "0" + String(now.minute(),DEC);
  }
  else{
    dataString = dataString + String(now.minute(),DEC);
  }

  if(now.second()<10){
    dataString = dataString + "0" + String(now.second(),DEC);
  }
  else{
    dataString = dataString + String(now.second(),DEC);
  }
